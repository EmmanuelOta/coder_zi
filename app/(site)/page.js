	...
	return (
		<>
				...
				<div className="flex flex-col lg:flex-row items-center justify-center max-w-full p-4 my-5 lg:my-10">
					...
					<div className="w-full lg:w-[50%] p-4" data-aos="fade-down">
						...
						<a
							...
							className="mx-1 inline-flex items-center justify-center w-full font-semibold p-2 text-center lg:text-left"
						>
							Wanderlust
							<svg
								xmlns="http://www.w3.org/2000/svg"
			...
			>
				...
				<div
					className="flex flex-col items-center justify-center p-2 w-max bg-slate-100 dark:bg-zinc-800 border border-slate-300 dark:border-zinc-600 rounded-2xl my-8"
					data-aos="fade-up"
				>
